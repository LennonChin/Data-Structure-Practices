 ...
 * @description: 以森林为基础而实现的并查集，递归压缩所有的路径节点
 * @author: Lennon Chin
 * @create: 2018/08/11 19:07:47
 */
public class UnionFindTreeOptimizeRoutesImpl implements UnionFind {
    
    private int[] parent;
    private int[] treesRank;
    
    public UnionFindTreeOptimizeRoutesImpl(int size) {
